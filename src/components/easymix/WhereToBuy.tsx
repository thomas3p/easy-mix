/**
 * WhereToBuy
 * แสดงช่องทางการซื้อพร้อม logo จริงของแต่ละแบรนด์
 * แทนที่ initial letter เดิม
 */
...
const WhereToBuy = ({
  ...
  subtitle = "เลือกซื้อ Easy Mix ได้ที่ช่องทางที่คุณสะดวก",
}: Props) => {
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <span className="text-xs text-muted-foreground">
            {c.type === "online" ? "ออนไลน์" : "ร้านค้าปลีก"}
          </span>
        </div>
      </div>
