...
const Footer = () => (
  <footer className="bg-muted/40 pt-12 md:pt-16 pb-8 border-t border-border">
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10 mb-10 md:mb-12">
        ...
        <div className="col-span-2 md:col-span-1">
          <img src={logo} alt="Easy Mix" className="h-12 w-auto mb-4" />
        ...
        <div>
          <h4 className="font-bold mb-3 text-sm md:text-base">เมนู</h4>
        ...
        <div>
          <h4 className="font-bold mb-3 text-sm md:text-base">ช่วยเหลือ</h4>
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/contact" className="hover:text-primary transition-smooth">นโยบายความเป็นส่วนตัว</Link></li>
          </ul>
        </div>

        <div>
          <h4 className="font-bold mb-3 text-sm md:text-base">ติดต่อเรา</h4>
          <ul className="space-y-2.5 text-sm text-muted-foreground">
            <li className="flex items-center gap-2"><Phone         className="h-4 w-4 text-primary shrink-0" /> 02-123-4567</li>
            <li className="flex items-center gap-2"><MessageCircle className="h-4 w-4 text-primary shrink-0" /> @easymix</li>
            <li className="flex items-center gap-2"><Mail          className="h-4 w-4 text-primary shrink-0" /> hello@easymix.co</li>
            <li className="flex items-center gap-2"><Facebook      className="h-4 w-4 text-primary shrink-0" /> EasyMix Official</li>
          </ul>
        </div>
      </div>
